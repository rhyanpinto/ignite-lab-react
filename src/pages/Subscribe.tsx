...
export function Subscribre() {
    ...
    return (
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center pt-6">
            <div className="w-4/5 flex gap-12 felx col items-center lg:w-full lg:max-w-[68.75rem] lg:flex-row lg:justify-between mt-20 mx-auto lg:mt-10">
            ...
            <img src="/src/assets/code-mockup.png" className="mt-10" alt="Imagem de um código" />
            <Footer />
        </div>
    );
}